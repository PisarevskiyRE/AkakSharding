...
// 1 инициализировать объекты кластера
// 2 подписаться на события кластера в престарте
// 3 отключится от самого себя и постстопе
// 4 при подключении отправить прветсвенное письмо
// 5 удалить пользователя
// 6 добавить пользователя
// 7 отправить всем сообщение
